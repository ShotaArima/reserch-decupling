...
```bash
uv run python -u scenarios/scenario20_role_clarification_deep_diagnosis/run.py \
  --device auto --seeds 42 52 62 --steps 120 \
  | tee scenarios/scenario20_role_clarification_deep_diagnosis/output/process.log
```
